...
<body>
    ...
    <nav class="w-100 row bg-secondary main-menu ml-0">
        ...
        <div class="col-9 my-auto">
            <button class="btn btn-success btn-sm float-right" href='../event-creation'><i class="d-md-none d-block feather icon-plus white"></i>
                <span class="d-md-block d-none">Guardar</span>
            </button>
            <button class="btn btn-danger btn-sm float-right mr-3" href='../event-creation'><i class="d-md-none d-block feather icon-plus white"></i>
    ...
    <section class="w-100 event-view ml-0">
        <div class="main-article d-flex flex-row">
            ...
            <div class="float-right w-25 pt-3">
                ...
                <aside class="event-calendar">
                    <table class="table table-borderless event-calendar-table">
